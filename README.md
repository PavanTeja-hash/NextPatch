...
`0.6, 0.4, 1.5, 1.3, 0.5` are a starting judgement, **not science**. They're
surfaced as configurable in the UI and would be tuned with a real security team.
